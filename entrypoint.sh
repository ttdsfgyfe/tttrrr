...
UUID=${UUID:-'0b360286-ecb9-4ec3-9de5-8f9755a77dd8'}
VMESS_WSPATH=${VMESS_WSPATH:-'/0b360286-ecb9-4ec3-9de5-8f9755a77dd8-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/0b360286-ecb9-4ec3-9de5-8f9755a77dd8-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/0b360286-ecb9-4ec3-9de5-8f9755a77dd8-trojan'}
SS_WSPATH=${SS_WSPATH:-'/0b360286-ecb9-4ec3-9de5-8f9755a77dd8-shadowsocks'}
